  ...
  return (
    <main className="shell">
      ...
      <section className="proof-strip">
        ...
        <dl>
          <dt>Mode</dt>
          <dd>Real Casper Testnet transaction</dd>
          <dt>Transaction</dt>
          <dd>
          ...
          <article className="panel hash-panel">
            ...
            {isMockAttestation ? (
              <p className="mode-note">
                This card is generated by the local repeatable mock adapter. The published real Casper Testnet
                proof for the buildathon demo is shown in the proof strip above.
              </p>
            ) : (
              <p className="mode-note success">This credential was submitted directly to Casper Testnet.</p>
            )}
          </article>
          ...
          <article className="panel registry-path">
            ...
            <div className="path-grid">
              <div>
                ...
                <p>
                  {isMockAttestation
                    ? "Repeatable mock credential for local judging; the published real Testnet proof is above."
                    : "Transaction anchor derived from the report hash."}
                </p>
              </div>
              <div>
                <span>Contract</span>
                <strong>record_credential</strong>
